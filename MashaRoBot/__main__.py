...
๏ ɪᴍ ᴏɴᴇ ᴏꜰ ᴛʜᴇ ᴩᴏᴡᴇʀꜰᴜʟʟ ɢʀᴏᴜᴩ ᴍᴀɴᴀɢɪɴɢ 
┏━━━━━•❃°•°❀°•°❃•━━━━┓
×  `{}` users, across `{}` chats..
┗━━━━━•❃°•°❀°•°❃•━━━━┛
...
buttons = [
    ...
    [
        ...
        InlineKeyboardButton(text="✨ 𝐒𝐮𝐩𝐩𝐨𝐫𝐭✨", url="https://t.me/KOMBOTZZSUPPORT"),
    ],
    [
...
def main():
    ...
    if SUPPORT_CHAT is not None and isinstance(SUPPORT_CHAT, str):
        try:
            dispatcher.bot.sendMessage(f"@{SUPPORT_CHAT}", "[Yes I am Back to online!](https://telegra.ph/file/85d22978cb6bda06397cf.jpg)", parse_mode=ParseMode.MARKDOWN) 
        except Unauthorized:
            LOGGER.warning(
